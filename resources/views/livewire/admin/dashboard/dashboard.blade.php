    ...
    <main id="main" class="main">
        ...
        <div class="">
            <div class="row">
                    ...
                    <div class="card-1">
                        ...
                        <div class="row">
                            ...
                            <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                <i class="bi bi-bar-chart-line-fill text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                <i class="bi bi-globe-central-south-asia text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card-4">
                        ...
                        <div class="row">
                            <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Monthly Ratings</p>
                                <h5 class="font-weight-bolder mb-0">
                                103
                                <span class="text-success text-sm font-weight-bolder">+5%</span>
                                </h5>
                            ...
                            <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                <i class="bi bi-bookmark-star text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="col-lg-5 mb-lg-0 mt-4">
                    <div class="card-5 z-index-2">
                        <div class="card-body p-3">
                        <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                            <div class="chart">
                            <canvas id="chart-bars" class="chart-canvas" style="/* display: block; *//* box-sizing: border-box; *//* height: 169.6px; *//* width: 341.6px; */"></canvas>
                            </div>
                        </div>
                        ...
                        <div class="container border-radius-lg">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder">925</h4>
                                <div class="progress w-75">
                                <div class="progress-bar bg-dark w-75" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                ...
                                <h4 class="font-weight-bolder">2mins</h4>
                                <div class="progress w-75">
                                <div class="progress-bar bg-dark w-50" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Ratings</p>
                                </div>
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Requests</p>
                                </div>
                ...
                <div class="col-lg-7 col-md-6 mb-md-0 mt-4">
                    <div class="card-6">
                        ...
                        <div class="row">
                            ...
                            <p class="text-sm mb-0">
                                <i class="bi bi-check2-circle text-secondary" aria-hidden="true"></i>
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Academic Performance</h6>
                                    </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Right Course Program</h6>
                                    </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Enrollment Process</h6>
                                    </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Organization Teams</h6>
                                    </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Department Syllabus</h6>
                                    </div>
                                    </div>
                                </td>
                                <td>
