            ...
            <div class="row">
                <ul class="nav nav-tabs nav-tabs-vertical-custom col-md-2 col-sm-12 pr-0" id="v-tabs-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link rounded-left" id="v-tabs-general-tab" data-toggle="tab" href="#v-tabs-general" role="tab" aria-controls="v-tabs-general" aria-selected="false">General</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active rounded-left" id="v-tabs-preference-tab" data-toggle="tab" href="#v-tabs-preference" role="tab" aria-controls="v-tabs-preference" aria-selected="true">Preferences</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link rounded-left" id="v-tabs-account-tab" data-toggle="tab" href="#v-tabs-account" role="tab" aria-controls="v-tabs-account" aria-selected="false">Account</a>
                  </li>
                  <li class="nav-item" role="presentation">
