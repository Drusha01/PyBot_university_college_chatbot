        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            ...
            <ul class="navbar-nav navbar-nav-right bs-borderbox">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class='bi bi-bell fs-20 mx-0'></i>
                        <span class="count">4</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                        <div>
                            <p class="mb-0 font-weight-normal text-center float-left dropdown-header border-bottom w-100">You have 4 new notifications</p>
                        </div>
                        <div>
                            <a class="dropdown-item preview-item">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject fs-15 font-weight-normal w-100">Application Error</h6>
                                    <p class="font-weight-light text-small mb-0 text-muted">
                                        Just now
                                    </p>
                                </div>
                            </a>
                ...
                <li class="nav-item nav-profile dropdown text-dark px-2">
                    <div>
                        <a class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="profileDropdown">
                            <div class="d-flex">
